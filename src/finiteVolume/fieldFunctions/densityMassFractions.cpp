...
ablate::finiteVolume::fieldFunctions::DensityMassFractions::DensityMassFractions(std::shared_ptr<ablate::finiteVolume::fieldFunctions::CompressibleFlowState> flowStateIn,
    ...
    : ablate::domain::FieldMathFunction(CompressibleFlowFields::DENSITY_YI_FIELD, flowStateIn->GetFieldFunction(CompressibleFlowFields::DENSITY_YI_FIELD), region) {}

#include "registrar.hpp"
REGISTER(ablate::domain::FieldMathFunction, ablate::finiteVolume::fieldFunctions::DensityMassFractions, "initializes the densityYi conserved field variables based upon a CompressibleFlowState",
