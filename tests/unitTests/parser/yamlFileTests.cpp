...
TEST(YamlParserTests, ShouldLocateLocalFile) {
    ...
    // act
    auto computedFilePath = yamlParser->Get(cppParser::ArgumentIdentifier<std::filesystem::path>{.inputName = "fileName"});
...
TEST(YamlParserTests, ShouldLocateFileNextToInputFile) {
    ...
    // act
    auto computedFilePath = yamlMeshFactory->Get(cppParser::ArgumentIdentifier<std::filesystem::path>{.inputName = "fileName"});
